// components/agenda/Icon.tsx
// Iconos SVG inline centralizados. Añadir iconos aquí, nunca en componentes.
// @usedBy todos los módulos

import React from 'react';

type IconName =
  | 'check' | 'plus' | 'trash' | 'edit' | 'close' | 'arrow-left' | 'arrow-right'
  | 'chevron-down' | 'chevron-up' | 'chevron-right'
  | 'habits' | 'tasks' | 'today' | 'projects' | 'calendar' | 'stats' | 'coach' | 'settings'
  | 'star' | 'fire' | 'trophy' | 'sparkle'
  | 'sun' | 'moon' | 'cloud'
  | 'clock' | 'flag' | 'tag' | 'repeat' | 'send' | 'bot';
...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  trash:         <path strokeLinecap="round" strokeLinejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6M9 7h6m-7 0a2 2 0 00-2-2h10a2 2 0 00-2 2M9 7H5m14 0h-4" />,
  ...
  'arrow-left':  <path strokeLinecap="round" strokeLinejoin="round" d="M15 19l-7-7 7-7" />,
  ...
  today:    <path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />,
  ...
  sparkle: <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />,
  ...
  clock:  <><circle cx="12" cy="12" r="9" strokeLinecap="round" strokeLinejoin="round" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6l4 2" /></>,
  ...
  bot:    <><rect x="3" y="11" width="18" height="10" rx="2" strokeLinecap="round" strokeLinejoin="round" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 11V7m-4 4V9a4 4 0 018 0v2M8 16h.01M16 16h.01" /></>,
};
